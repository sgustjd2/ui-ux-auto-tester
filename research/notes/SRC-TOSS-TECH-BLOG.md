...
- Verified on: 2026-09-23 (eight articles downloaded; titles, bylines, dates, and the relevant passages read)
...
| 달리는 기차 바퀴 칠하기: 7년만의 컬러 시스템 업데이트 (/article/tds-color-system-update) | 2025-12-15 | 윤민석/권윤 | TDS color system rebuilt after seven years (discovery scan: OKLCH-based, contrast-aware pairs; details not re-read) |
| 세금 환급 자동화: AI-driven UI 테스트 자동화 일지 (/article/ai-driven-ui-test-automation) | 2025-12-24 | 정수호, QA Manager | AI-agent-assisted E2E UI test automation for a complex tax-refund service (discovery scan: 35 tests, pass rate raised after handling interaction readiness; details not re-read) |
...
- Two articles (color system, AI test automation) were identified and dated but their details were taken from the discovery scan, not re-read.
