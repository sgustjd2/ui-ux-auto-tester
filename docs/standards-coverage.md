...
| UX-INTERACTION-LAWS | Interaction principles and laws | SRC-LAWSOFUX-INDEX, SRC-NNG-ARTICLES, SRC-FITTS-1954, SRC-HICK-1952, SRC-MILLER-1956, SRC-MURDOCK-1962, SRC-KIVETZ-2006, SRC-HUNT-1995, SRC-WAGEMANS-2012 | COVERED | NOT_STARTED | Verified 2026-09-23 (GAP-035 resolved): every law in prd.md 7.3 has a T3 anchor except the Doherty Threshold. Primary papers for Fitts, Hick, Miller, serial position, goal gradient, von Restorff (via Hunt), and Gestalt grouping (via the Wagemans review; Prägnanz is not anchored); NN/g pages for Fitts, Hick, Jakob, Miller, Tesler, Zeigarnik, Peak-End, aesthetic-usability, Pareto, serial position, and the Gestalt principles. The Doherty Threshold has no T3 source: no rule is minted from its 400 ms figure, and response-time rules use the NN/g response-time limits and Core Web Vitals instead (GAP-062). Laws of UX stays a T4 discovery index |
...
| UX-NAVIGATION | Navigation UX | SRC-NNG-ARTICLES, SRC-KR-KRDS | COVERED | NOT_STARTED | Verified 2026-09-02: NN/g. 2026-09-23: KRDS (Korean government design system, 2025.08 guideline) added for Korean public-sector services; its search and navigation guidance is not yet read in detail. |
| UX-SEARCH | Search UX | SRC-NNG-ARTICLES, SRC-KR-KRDS | COVERED | NOT_STARTED | Verified 2026-09-02: NN/g. 2026-09-23: KRDS (Korean government design system, 2025.08 guideline) added for Korean public-sector services; its search and navigation guidance is not yet read in detail. |
...
| OTH-LOCALIZATION | Localization | SRC-W3C-I18N, SRC-GOVUK-DESIGN-SYSTEM, SRC-UNICODE-UTS35 | COVERED | NOT_STARTED | Verified 2026-09-23: W3C i18n techniques (text expansion, language switching, names); Unicode UTS #35 with CLDR as the reference for locale-sensitive date, time, number, and currency formatting; GOV.UK Addresses and Names patterns for name and address assumptions. GAP-038 resolved (was PARTIAL after the first review) |
| OTH-I18N | Internationalization | SRC-W3C-I18N, SRC-W3C-KLREQ, SRC-UNICODE-UTS35 | COVERED | NOT_STARTED | Verified 2026-09-23: W3C i18n techniques plus Hangul layout requirements (Group Note Draft) for Korean text, and Unicode UTS #35 locale data (plural rules, numbering systems, direction data) |
...
| OTH-CONSENT-UX | Consent UX | SRC-EU-GDPR, SRC-EDPB-CONSENT, SRC-KR-PIPA | COVERED | NOT_STARTED | Verified 2026-09-23: GDPR Art. 4(11) and 7, EDPB Guidelines 05/2020 v1.1, PIPA Art. 22 (current text 법률 제21445호). Scope: consent interface design (clarity, granularity, withdrawal, timing) is covered; which cookies or trackers legally require consent is out of the covered scope until the ePrivacy Directive is registered (GAP-046) |
| OTH-DARK-PATTERNS | Deceptive and dark patterns | SRC-EDPB-DECEPTIVE, SRC-FTC-DARK-PATTERNS, SRC-EU-DSA, SRC-KR-ECOMMERCE-ACT, SRC-TOSS-APPS-IN-TOSS | COVERED | NOT_STARTED | Verified 2026-09-23: DSA Art. 25 (EU, online platforms only, and residual: it excludes practices covered by the UCPD or GDPR, so EU consumer dark patterns have no LEGAL anchor until the UCPD is registered) and Korean E-Commerce Act Art. 21-2 (KR) as LEGAL anchors; EDPB 03/2022 taxonomy (6 categories, 16 types) and FTC 2022 report (8 pattern types) as BEST_PRACTICE; Apps in Toss five banned patterns (T2 on that platform). EU UCPD not registered (GAP-046) |
