...
| OTH-LOCALIZATION | Localization | SRC-W3C-I18N | PARTIAL | NOT_STARTED | W3C i18n techniques and a representative article verified 2026-09-23 (text expansion, language switching, names). Still owed: normative anchors for locale-sensitive date, time, number, and currency formatting and for address assumptions (prd.md 10.12), GAP-038. Set PARTIAL after review |
